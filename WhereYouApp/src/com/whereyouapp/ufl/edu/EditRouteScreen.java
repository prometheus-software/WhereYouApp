...
import android.view.*;
public class EditRouteScreen extends Activity {
	...
	public boolean wentToMap = false;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_edit_route_screen);
		...
		editText.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
		editText = (EditText) findViewById(R.id.edit_enter_contact);
		editText.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
		editText = (EditText) findViewById(R.id.edit_enter_contact6);
		editText.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
	...
	public void onRadioButtonClicked (View view)
	{
		...
		if(view.getId() == R.id.edit_mile){
			if(checked)
				factor = 1;
		}
		else if(view.getId() == R.id.edit_km){
			if(checked)
				factor = 0.621371;
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.edit_route_screen, menu);
		return true;
	}
	...
	public void onRestart(MenuItem menuItem)
	{
		...
		TextView textView = (TextView) findViewById(R.id.edit_display_address);
		...
		editText = (EditText) findViewById(R.id.edit_enter_contact6);
		editText.setText("", TextView.BufferType.EDITABLE);
		RadioGroup kmMile = (RadioGroup) findViewById(R.id.edit_km_mile);
		kmMile.check(R.id.edit_mile);
	...
	public void onResume()
	{
		...
		{
			RadioGroup group = (RadioGroup) findViewById(R.id.edit_km_mile);
			oldDistance = routes.get(position1).getDistance();
			if (oldDistance == .10)
			{
				spinner2.setSelection(0);
	...
	public void saveRoute(MenuItem menuItem)
	{
		...
		RadioButton button1 = (RadioButton) findViewById(R.id.edit_mile);
		RadioButton button2 = (RadioButton) findViewById(R.id.edit_km);
		...
		if(b != null) 
		{
			...
			dbHandle.updateRoute(oldName, name, coords, phoneNumbers, radiusCode, theMessage, addr, alarm, time, days);
