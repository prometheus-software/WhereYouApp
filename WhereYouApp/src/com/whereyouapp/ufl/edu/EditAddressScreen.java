...
GooglePlayServicesClient.OnConnectionFailedListener, LocationListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(servicesOK())
		{
			...
			EditText et = (EditText) findViewById(R.id.edit_editText1);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.edit_address_screen, menu);
	...
	private boolean initializeMap()
	{
		if(myMap == null)
		{
			...
			SupportMapFragment mapFrag = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.edit_myMap);
			myMap = mapFrag.getMap();
			destinationIntent = new Intent(this, EditRouteScreen.class);
			myMap.setMyLocationEnabled(true);
			...
			myMap.setOnMarkerClickListener(new OnMarkerClickListener()
			{
				public boolean onMarkerClick(Marker arg0) {    
					startAddRouteScreen(EditAddressScreen.destinationIntent, arg0);
				return true;
				}
			});
		}
	...
	{
		if(item.getItemId() == R.id.editmapTypeNormal)
			myMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
		else if(item.getItemId() == R.id.editmapTypeSatellite)
			myMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
		else if(item.getItemId() == R.id.editmapTypeTerrain)
	...
	{
		EditText editText = (EditText) findViewById(R.id.edit_editText1);
